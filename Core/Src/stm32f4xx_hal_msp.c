...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, nRF_B_SCK_Pin|nRF_B_MISO_Pin|nRF_B_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, nRF_EL_MISO_Pin|nRF_EL_MOSI_Pin);

    HAL_GPIO_DeInit(nRF_EL_SCK_GPIO_Port, nRF_EL_SCK_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, ESP32_SCK_Pin|ESP32_MISO_Pin|ESP32_MOSI_Pin);
